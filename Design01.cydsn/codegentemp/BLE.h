...
/* Tx Power Level */
#define CYBLE_TX_POWER_LEVEL_ADV                    (CYBLE_LL_PWR_LVL_NEG_18_DBM)
...
#define CYBLE_ADV_PKT_INDEX_MANUFACTURER_DATA   (0x0Au)
...
#define CYBLE_GATT_MAX_ATTR_LEN             ((0x0005u == 0u) ? (1u) : (0x0005u))
